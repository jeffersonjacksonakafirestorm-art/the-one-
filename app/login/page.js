  ...
  return (
    <div style={S.page}>
      <div style={S.box}>
        ...
        <p style={S.sub}>Enter your email and we'll send you a login code.</p>
        <form onSubmit={handleSubmit}>
          ...
          <button style={S.btn} disabled={loading}>{loading ? 'Sending code...' : 'Send login code →'}</button>
        </form>
        <div style={S.switch}>New here? <Link href="/signup" style={S.link}>Create account</Link></div>
      </div>
    </div>
  )
}
